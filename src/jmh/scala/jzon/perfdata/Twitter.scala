...
object Urls {
  implicit val jDecoder: jzon.Decoder[Urls] = jzon.Decoder.derived
  implicit val jEncoder: jzon.Encoder[Urls] = jzon.Encoder.derived
...
object Url {
  implicit val jDecoder: jzon.Decoder[Url] = jzon.Decoder.derived
  implicit val jEncoder: jzon.Encoder[Url] = jzon.Encoder.derived
  implicit val customConfig: circe.generic.extras.Configuration =
    circe.generic.extras.Configuration.default
...
object UserEntities {
  implicit val jDecoder: jzon.Decoder[UserEntities] = jzon.Decoder.derived
  implicit val jEncoder: jzon.Encoder[UserEntities] = jzon.Encoder.derived
  implicit val customConfig: circe.generic.extras.Configuration =
    circe.generic.extras.Configuration.default
...
object UserMentions {
  implicit val jDecoder: jzon.Decoder[UserMentions] = jzon.Decoder.derived
  implicit val jEncoder: jzon.Encoder[UserMentions] = jzon.Encoder.derived
  implicit val customConfig: circe.generic.extras.Configuration =
    circe.generic.extras.Configuration.default
...
object User {
  implicit val jDecoder: jzon.Decoder[User] = jzon.Decoder.derived
  implicit val jEncoder: jzon.Encoder[User] = jzon.Encoder.derived
  implicit val customConfig: circe.generic.extras.Configuration =
    circe.generic.extras.Configuration.default
...
object Entities {
  implicit val jDecoder: jzon.Decoder[Entities] = jzon.Decoder.derived
  implicit val jEncoder: jzon.Encoder[Entities] = jzon.Encoder.derived
  implicit val customConfig: circe.generic.extras.Configuration =
    circe.generic.extras.Configuration.default
...
object RetweetedStatus {
  implicit val jDecoder: jzon.Decoder[RetweetedStatus] =
    jzon.Decoder.derived
  implicit val jEncoder: jzon.Encoder[RetweetedStatus] =
...
object Tweet {
  implicit val jzonDecoder: jzon.Decoder[Tweet] = jzon.Decoder.derived
  implicit val jzonEncoder: jzon.Encoder[Tweet] = jzon.Encoder.derived
  implicit val customConfig: circe.generic.extras.Configuration =
    circe.generic.extras.Configuration.default

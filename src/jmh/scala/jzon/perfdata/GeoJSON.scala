...
package handrolled {
  ...
  object Geometry {
    ...
    implicit lazy val jzonDecoder: jzon.Decoder[Geometry] =
      new jzon.Decoder[Geometry] {
        import jzon._, internal._, Decoder.{ JsonError, UnsafeJson }
  ...
  object GeoJSON {
    ...
    // of a corner case.
    implicit lazy val jzonDecoder: jzon.Decoder[GeoJSON] =
      new jzon.Decoder[GeoJSON] {
        import jzon._, internal._, Decoder.{ JsonError, UnsafeJson }
        import scala.annotation._
